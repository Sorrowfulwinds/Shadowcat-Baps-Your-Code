...
#define ROLE_UNAVAILABLE_WHITELIST (1<<4)
/// character issue; age, faction, etc
#define ROLE_UNAVAILABLE_CHAR_AGE (1<<5)
/// character is of wrong faction
#define ROLE_UNAVAILABLE_CHAR_FACTION (1<<6)
/// character is of wrong species
#define ROLE_UNAVAILABLE_CHAR_SPECIES (1<<7)
