...
/obj/item/storage/pill_bottle/antitox
	...
	labeled = 1
	bottle_color = "green"
	starts_with = alist(/obj/item/reagent_containers/pill/antitox = 7)
...
/obj/item/storage/pill_bottle/bicaridine
	...
	labeled = 1
	bottle_color = "red"
	starts_with = alist(/obj/item/reagent_containers/pill/bicaridine = 7)
...
/obj/item/storage/pill_bottle/dexalin_plus
	...
	labeled = 1
	bottle_color = "blue"
	starts_with = alist(/obj/item/reagent_containers/pill/dexalin_plus = 7)

/obj/item/storage/pill_bottle/dermaline
	name = "bottle of Dermaline pills"
	desc = "Contains pills used to treat burn wounds."
	labeled = 1
	starts_with = alist(/obj/item/reagent_containers/pill/dermaline = 7)
...
/obj/item/storage/pill_bottle/dylovene
	...
	labeled = 1
	bottle_color = "green"
	starts_with = alist(/obj/item/reagent_containers/pill/dylovene = 7)
...
/obj/item/storage/pill_bottle/inaprovaline
	...
	labeled = 1
	bottle_color = "blue"
	starts_with = alist(/obj/item/reagent_containers/pill/inaprovaline = 7)

/obj/item/storage/pill_bottle/kelotane
	name = "bottle of kelotane pills"
	desc = "Contains pills used to treat burns."
	labeled = 1
	starts_with = alist(/obj/item/reagent_containers/pill/kelotane = 7)
...
/obj/item/storage/pill_bottle/spaceacillin
	...
	labeled = 1
	bottle_color = "white"
	starts_with = alist(/obj/item/reagent_containers/pill/spaceacillin = 7)
...
/obj/item/storage/pill_bottle/tramadol
	...
	labeled = 1
	bottle_color = "purple"
	starts_with = alist(/obj/item/reagent_containers/pill/tramadol = 7)

/obj/item/storage/pill_bottle/citalopram
	name = "bottle of Citalopram pills"
	desc = "Contains pills used to stabilize a patient's mood."
	labeled = 1
	starts_with = alist(/obj/item/reagent_containers/pill/citalopram = 7)
...
/obj/item/storage/pill_bottle/carbon
	...
	labeled = 1
	bottle_color = "black"
	starts_with = alist(/obj/item/reagent_containers/pill/carbon = 7)
...
/obj/item/storage/pill_bottle/iron
	...
	labeled = 1
	bottle_color = "black"
	starts_with = alist(/obj/item/reagent_containers/pill/iron = 7)

/obj/item/storage/pill_bottle/adminordrazine
	name = "pill bottle (Adminordrazine)"
	desc = "It's magic. We don't have to explain it."
	starts_with = alist(/obj/item/reagent_containers/pill/adminordrazine = 21)

/obj/item/storage/pill_bottle/nutriment
	name = "pill bottle (Food)"
	desc = "Contains pills used to feed people."
	starts_with = alist(/obj/item/reagent_containers/pill/nutriment = 7, /obj/item/reagent_containers/pill/protein = 7)
...
/obj/item/storage/pill_bottle/rezadone
	...
	starts_with = alist(/obj/item/reagent_containers/pill/rezadone = 7)
...
/obj/item/storage/pill_bottle/peridaxon
	...
	starts_with = alist(/obj/item/reagent_containers/pill/peridaxon = 7)
...
/obj/item/storage/pill_bottle/carthatoline
	...
	starts_with = alist(/obj/item/reagent_containers/pill/carthatoline = 7)
	//wrapper_color = COLOR_GREEN_GRAY
...
/obj/item/storage/pill_bottle/alkysine
	...
	starts_with = alist(/obj/item/reagent_containers/pill/alkysine = 7)
	//wrapper_color = COLOR_YELLOW

/obj/item/storage/pill_bottle/imidazoline
	name = "pill bottle (Imidazoline)"
	desc = "Heals eye damage."
	starts_with = alist(/obj/item/reagent_containers/pill/imidazoline = 7)
...
/obj/item/storage/pill_bottle/osteodaxon
	...
	starts_with = alist(/obj/item/reagent_containers/pill/osteodaxon = 7)
...
/obj/item/storage/pill_bottle/myelamine
	...
	starts_with = alist(/obj/item/reagent_containers/pill/myelamine = 7)
...
/obj/item/storage/pill_bottle/hyronalin
	...
	starts_with = alist(/obj/item/reagent_containers/pill/hyronalin = 7)
...
/obj/item/storage/pill_bottle/arithrazine
	...
	starts_with = alist(/obj/item/reagent_containers/pill/arithrazine = 7)
	//wrapper_color = COLOR_TEAL
...
/obj/item/storage/pill_bottle/corophizine
	...
	starts_with = alist(/obj/item/reagent_containers/pill/corophizine = 7)
...
/obj/item/storage/pill_bottle/healing_nanites
	...
	starts_with = alist(/obj/item/reagent_containers/pill/healing_nanites = 7)
