...
/datum/antagonist/proc/get_check_antag_output(var/datum/admins/our_caller)
	...
	for(var/datum/mind/player in current_antagonists)
		...
		if(M)
			...
			dat += "</td>"
			dat += "<td>\[<A HREF='?src=\ref[our_caller];adminplayeropts=\ref[M]'>PP</A>]\[<A href='?src=\ref[our_caller];priv_msg=\ref[M]'>PM</A>\]\[<A href='?src=\ref[our_caller];traitor=\ref[M]'>TP</A>\]</td>"
		else
...
/datum/antagonist/proc/get_additional_check_antag_output(var/datum/admins/our_caller)
	return ""
