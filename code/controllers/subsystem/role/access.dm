...
/datum/controller/subsystem/role/proc/init_access()
	access_datums = list()
 ...
 */
/datum/controller/subsystem/role/proc/access_datums_of_type(access_type)
 ...
 */
/datum/controller/subsystem/role/proc/access_datums_of_region(access_region)
 ...
 */
/datum/controller/subsystem/role/proc/access_datums_of_category(access_category)
	return access_category_list(access_category).Copy()

/**
 * get all access ids in the game
 */
/datum/controller/subsystem/role/proc/access_ids()
	. = list()
 ...
 * * access_type - type flags
 */
/datum/controller/subsystem/role/proc/access_ids_of_type(access_type)
	. = list()
 ...
 * * access_region - region flags
 */
/datum/controller/subsystem/role/proc/access_ids_of_region(access_region)
	. = list()
 ...
 * * access_category - category enum
 */
/datum/controller/subsystem/role/proc/access_ids_of_category(access_category)
	. = list()
	for(var/datum/access/A as anything in access_category_list(access_category))
		. += A.access_value

/datum/controller/subsystem/role/proc/access_type_list(access_type)
	PRIVATE_PROC(TRUE)
	RETURN_TYPE(/list)
...
/datum/controller/subsystem/role/proc/access_region_list(access_region)
	PRIVATE_PROC(TRUE)
	RETURN_TYPE(/list)
...
/datum/controller/subsystem/role/proc/access_category_list(access_category)
	PRIVATE_PROC(TRUE)
	RETURN_TYPE(/list)
 ...
 */
/datum/controller/subsystem/role/proc/access_lookup(id_or_path)
 ...
 */
/datum/controller/subsystem/role/proc/access_lookup_multiple(list/ids_or_paths)
	. = list()
 ...
 */
/datum/controller/subsystem/role/proc/tgui_access_data()
	var/list/data = list()
	for(var/datum/access/A as anything in access_datums)
		data[++data.len] = list(
 ...
 */
/datum/controller/subsystem/role/proc/editable_access_ids_by_id(id)
