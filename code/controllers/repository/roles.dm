...
/datum/controller/repository/roles/load(datum/prototype/role/instance)
	...
	if(!.)
		return
	if(istype(instance, /datum/prototype/role/legacy_job))
		var/datum/prototype/role/legacy_job/casted_job = instance
...
/**
 * Only returns /datum/prototype/role/legacy_job
 */
/datum/controller/repository/roles/proc/legacy_job_by_title(title) as /datum/prototype/role/legacy_job
	return legacy_job_title_lookup[title]

/**
 * Only returns /datum/prototype/role/legacy_job
 */
/datum/controller/repository/roles/proc/legacy_job_by_id(id) as /datum/prototype/role/legacy_job
	return fetch_local_or_throw(id)

/**
 * Only returns /datum/prototype/role/legacy_job
 */
/datum/controller/repository/roles/proc/legacy_job_by_type(type) as /datum/prototype/role/legacy_job
...
/datum/controller/repository/roles/proc/legacy_all_job_ids(filter_faction) as /list
	. = list()
	for(var/datum/prototype/role/legacy_job/r as anything in fetch_subtypes_immutable(/datum/prototype/role/legacy_job))
		. += r.id
