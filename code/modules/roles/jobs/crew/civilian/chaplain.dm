/datum/prototype/role/job/chaplain
	id = "JobNtChaplain"
	title = "Chaplain"

	menu_blurb = "The Chaplain ministers to the spiritual needs of the crew."

	spawn_blurb = "You work in the chapel and report to the Head of Personnel.\n"

	outfit = /datum/outfit/job/station/chaplain
	...
	alt_titles = list(
		/datum/prototype/alt_title/chaplain/therapist::id,
		/datum/prototype/alt_title/chaplain/counselor::id,
	)
...
/datum/prototype/alt_title/chaplain/therapist
	id = "AltChaplainTherapist"
	title = "Therapist"

/datum/prototype/alt_title/chaplain/counselor
	id = "AltChaplainCounselor"
	title = "Counselor"
