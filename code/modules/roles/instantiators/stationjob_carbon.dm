...
/datum/role_instantiator/job/AttemptSpawn(client/C, datum/prototype/role/job/job, datum/prototype/alt_title)
...
/datum/role_instantiator/job/ForceSpawn(client/C, datum/prototype/role/role, datum/prototype/alt_title)
