...
/obj/item/organ/external/head/removed()
	if(owner)
		if(iscarbon(owner))
			...
			//spawn(1) //Removed 4/1/2024, This appears to do nothing and causes the checks above it to become stale. If this needs to be added back in consider moving it above if(owner). ~Shadowcat
				owner.update_hair()
	get_icon()
	..()
