...
/datum/category_item/player_setup_item/occupation/jobs/proc/render_job(datum/preferences/prefs, datum/prototype/role/legacy_job/J, current_priority, assistant_selected)
	. = list()
 ...
 */
/datum/category_item/player_setup_item/occupation/jobs/proc/check_job(datum/preferences/prefs, datum/prototype/role/legacy_job/J, current_priority)
...
/datum/category_item/player_setup_item/occupation/jobs/act(datum/preferences/prefs, mob/user, action, list/params)
	switch(action)
		...
		if("title")
			var/datum/prototype/role/legacy_job/J = RSroles.legacy_job_by_id(params["title"])
			if(!J)
			...
			return PREFERENCES_REFRESH_UPDATE_PREVIEW
		if("help")
			var/datum/prototype/role/legacy_job/J = RSroles.legacy_job_by_id(params["help"])
...
/datum/preferences/proc/available_alt_titles(datum/prototype/role/legacy_job/J)
	RETURN_TYPE(/list)
	return J.alt_title_query(all_background_ids())

/datum/preferences/proc/check_alt_title(datum/prototype/role/legacy_job/J, alt_title)
...
/datum/preferences/proc/get_job_priority(datum/prototype/role/legacy_job/J)
	var/list/jobs = get_character_data(CHARACTER_DATA_JOBS)
	return jobs[J.id]

/datum/preferences/proc/get_job_alt_title_name(datum/prototype/role/legacy_job/J)
...
/datum/preferences/proc/effective_job_priority(datum/prototype/role/legacy_job/J)
