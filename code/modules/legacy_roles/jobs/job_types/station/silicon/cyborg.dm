/datum/prototype/role/legacy_job/station/cyborg
	id = JOB_ID_CYBORG
	title = "Cyborg"
	flag = CYBORG
...
// Cyborg procs
/datum/prototype/role/legacy_job/station/cyborg/equip(var/mob/living/carbon/human/H)
	if(!H)	return 0
	return 1

/datum/prototype/role/legacy_job/station/cyborg/equip_preview(mob/living/carbon/human/H)
