/datum/prototype/role/legacy_job/station/ai
	id = JOB_ID_AI
	title = "AI"
	flag = AI
...
// AI procs
/datum/prototype/role/legacy_job/station/ai/equip(var/mob/living/carbon/human/H)
	if(!H)
		return 0
	return 1

/datum/prototype/role/legacy_job/station/ai/slots_remaining(latejoin)
	if(latejoin)
