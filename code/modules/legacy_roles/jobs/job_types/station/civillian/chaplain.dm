/datum/prototype/role/legacy_job/station/chaplain
	id = JOB_ID_CHAPLAIN
	title = "Chaplain"
	flag = CHAPLAIN
...
/datum/prototype/role/legacy_job/station/chaplain/equip(mob/living/carbon/human/H, src)
	. = ..()
	if(H.mind)
		H.mind.isholy = TRUE
/datum/prototype/role/legacy_job/station/chaplain/equip(var/mob/living/carbon/human/H, var/alt_title, var/ask_questions = TRUE)
	. = ..()
	if(!.)
		return
	if(!ask_questions)
