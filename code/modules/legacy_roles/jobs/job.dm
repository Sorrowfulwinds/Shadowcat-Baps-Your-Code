 ...
 */
/datum/prototype/role/legacy_job
	/// Abstract type.
	abstract_type = /datum/prototype/role/legacy_job
...
/datum/prototype/role/legacy_job/New()
	. = ..()
 ...
 */
/datum/prototype/role/legacy_job/proc/slots_remaining(latejoin)
	if(!latejoin)
 ...
 */
/datum/prototype/role/legacy_job/proc/check_client_availability(client/C, check_char, latejoin)
	. = NONE
 ...
 * todo: check ckey proc too?
 */
/datum/prototype/role/legacy_job/proc/check_client_availability_one(client/C, check_char, latejoin)
	. = NONE
	if(whitelist_only && !Configuration.check_role_whitelist(id, C.ckey))
 ...
 */
/datum/prototype/role/legacy_job/proc/check_mob_availability_one(mob/M)
	. = NONE
 ...
 */
/datum/prototype/role/legacy_job/proc/get_availability_reason(client/C, reason)
 ...
 */
/datum/prototype/role/legacy_job/proc/get_availability_error(client/C, reason)
	if(reason & ROLE_UNAVAILABLE_BANNED)
		return "BANNED"
	if(reason & ROLE_UNAVAILABLE_SLOTS_FULL)
		return "SLOTS FULL"
...
/datum/prototype/role/legacy_job/proc/player_old_enough(client/C)
	return (available_in_days(C) == 0)	// Available in 0 days = available right now = player is old enough to play.

/datum/prototype/role/legacy_job/proc/available_in_days(client/C)
